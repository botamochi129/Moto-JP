...
class Triangle {
    ...
    public Triangle(int[] v0, int[] v1, int[] v2) {
        // 頂点ごとにコピー
        this.vertex[0] = v0[0]; this.texCoord[0] = v0[1]; this.normal[0] = v0[2];
        this.vertex[1] = v1[0]; this.texCoord[1] = v1[1]; this.normal[1] = v1[2];
        this.vertex[2] = v2[0]; this.texCoord[2] = v2[1]; this.normal[2] = v2[2];
    }
}
